...
def main():
    ...
    for file in os.listdir('.'):
        if file.endswith('.fasta') and not file.startswith('scores') and not file.startswith('genome') and not file.startswith('target_'):
    ...
    sys.stdout = open('all_target_scores_merged', 'w')
