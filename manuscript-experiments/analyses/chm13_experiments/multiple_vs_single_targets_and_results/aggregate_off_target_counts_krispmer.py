...
def generate_scores_filename(target_filename_with_path):
    ...
    return '/'.join(splitted[:-2] + ['krispmer_grnas','scores_'+splitted[-1]])

def main():
    # take command line arguments
    parser = argparse.ArgumentParser(description='Process krispmer results.')
    ...
    for target_file, grna_file in target_files_and_grna_files:
        ...
        for tgt_in_plus, tgt_in_minus in grna_list:
            ...
            print(str(target_file).split('/')[-1], tgt_in_plus, ot_count_0_mismatch, ot_count_1_mismatch, ot_count_2_mismatch, num_occurrences_of_grna_in_genome)
